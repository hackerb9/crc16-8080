...
//	crc = crc_1nybble(crc, nh);
//	crc = crc_1nybble(crc, nl);
...
///////////////////////////////////////////////////////////////////////
// Everything below here is verbatim from Lemmert Bies's CRC library //
///////////////////////////////////////////////////////////////////////
...
uint16_t crc16xmodem_rem(uint16_t crc, unsigned val, unsigned bits) {
...
uint16_t crc16xmodem_comb(uint16_t crc1, uint16_t crc2,
        uintmax_t len2) {
